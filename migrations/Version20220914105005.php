 ...
 */
final class Version20220914105005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE menu (id INT NOT NULL, restaurant_id INT NOT NULL, name VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
